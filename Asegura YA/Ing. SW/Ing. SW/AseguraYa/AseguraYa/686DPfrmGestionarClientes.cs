    ...
    public partial class _686DPfrmGestionarClientes : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cargarDG(); // Refrescar después de cualquier acción
            }
            catch (Exception ex)
            {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error general en encriptación/desencriptación: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
